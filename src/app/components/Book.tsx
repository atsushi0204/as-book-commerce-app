...
const Book = ({ book, isPurchased }: BookProps) => {
  ...
  const purchasedToAlert = (_isPurchased: boolean):boolean => {
    if(_isPurchased){
      alert("すでに購入されたコンテンツです。");
      return true;
    }
    return false;
  };
  ...
  const handleToggle = () => {
    if (purchasedToAlert(isPurchased)) return;
      ...
      <div className="flex flex-col items-center m-4">
        ...
        >
          ...
          <div className="px-4 py-4 bg-slate-100 rounded-b-md">
            ...
            <p className="mt-2 text-lg text-slate-600 truncate">この本は...</p>
